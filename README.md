...
bash./install-openams.sh [-k <klipper path>] [-s <klipper service name>] [-c <configuration path>]
Initial Calibration
...
bash./install-afc.sh -b multi_extruder
...
bashcp AFC_AMS1.cfg <printer_data path>/config/AFC/
